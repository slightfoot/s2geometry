...
All 902 ported tests pass (3 skipped requiring extended precision). Code coverage for the ported files:
...
| s2_cap.dart | 100.0% |
| s2_cell.dart | 100.0% |
| s2_cell_id.dart | 95.4% |
| s2_cell_union.dart | 95.7% |
